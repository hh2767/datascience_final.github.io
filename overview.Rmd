...
<br><img src=".\\pictures\\phthalates_1.jpg" style="width:90%; border:10px solid"><br>
...
Phthalate exists in human body in different types. In the original dataset, eight types of phthalates in participants' urine were recorded. Therefore, we analyzed percent contribution of each type of phthalate to the sum-total phthalate and [visualized it](percentage.html).
